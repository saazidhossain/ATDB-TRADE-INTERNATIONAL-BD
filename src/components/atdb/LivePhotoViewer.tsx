...
import { useHostedRealPhotoFeed } from "@/lib/real-photos";
...
const FILTERS: Array<EquipmentCategory | "all"> = [
  "all",
  "rollers",
  "cranes",
  "excavators",
...
export function LivePhotoViewer() {
  ...
  const { photos, loading, refreshing, error, lastUpdated, refresh } =
    useHostedRealPhotoFeed(10000);
      ...
      <div className="container-page relative">
        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
          ...
          >
            ...
            >
              ...
              <p
                className={cn(
                  "text-[11px] font-bold uppercase tracking-[0.3em] text-bronze-glow",
                  fontClass,
                )}
              >
                Live fleet photos
            ...
            <motion.h2
              ...
              className={cn(
                "mt-4 text-4xl font-bold tracking-tight text-white md:text-5xl",
                fontClass,
              )}
            >
            ...
            >
              Hosted equipment photos appear here automatically with balanced cropping, clean
              spacing, and responsive viewing.
            </motion.p>
          </motion.div>
          ...
          >
            <motion.button
              ...
              whileTap={!refreshing ? { scale: 0.98, transition: { duration: 0.1 } } : undefined}
              className={cn(
            ...
            >
              <motion.div
                ...
                animate={refreshing ? { scale: [1, 1.2, 1] } : undefined}
        ...
        <AnimatePresence>
          {error && (
            ...
            >
              <div
                className={cn(
                  "flex items-center justify-between gap-3 rounded-md border border-destructive/40 bg-destructive/10 p-4 text-sm text-white backdrop-blur-sm",
                  fontClass,
                )}
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-white/70">
                      The live photo feed is temporarily unavailable. Please check your connection
                      or try again.
                    </p>
                  </div>
                </div>
        ...
        {loading && !active ? (
              ...
              >
                <AnimatePresence mode="wait">
                  <motion.img
                    ...
                    transition={{ duration: 0.8, ease: easingFunctions.smoothOut }}
                ...
                >
                  ...
                  >
                    ...
                    <p
                      className={`text-xs font-semibold uppercase tracking-[0.2em] text-bronze-glow ${fontClass}`}
                    >
                      {active.equipmentId}
                    </p>
                  </motion.div>
            ...
            <aside className="flex flex-col rounded-md border border-white/12 bg-white/[0.04] p-4 backdrop-blur-md">
              ...
              >
                <div className="flex items-center gap-2 text-white">
                  ...
                  <span className={`text-xs font-bold uppercase tracking-[0.16em] ${fontClass}`}>
          ...
          >
            ...
            <p
              className={`mt-6 text-sm font-bold uppercase tracking-[0.2em] text-white/80 ${fontClass}`}
            >
              Waiting for hosted photos
            </p>
            <p
              className={`mx-auto mt-3 max-w-md text-sm leading-relaxed text-white/50 ${fontClass}`}
            >
              Upload images into the equipment real-photo hosting folders and they will appear here
